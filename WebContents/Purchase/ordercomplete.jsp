...
<html>
<head>
<title>Darle - 구매완료</title>

<link href="orderstyle.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/team_file/js/rollover.js"></script>
</head>

<body onLoad="MM_preloadImages('images/facebook_01-02.jpg','images/instagram_02-05.jpg','images/youtube_03.jpg')">
<div class="wrap">
  <div class="page_header">
    ...
    <%
		...
		if (userId == null) {
	%>
    <a href="/team_file/Login/login.html">LOGIN</a>&nbsp;
	<a href="/team_file/SignUp/signUp.html">JOIN US</a>&nbsp; 
    <a href="/team_file/Cart/cart.jsp">CART</a>&nbsp; 
    <a href="/team_file/Purchase/purchase.html">ORDER</a> |
    <strong><a href="#">MY PAGE</a></strong>
    <%
		} else {
	%>
	<a href="/team_file/Login/logout.jsp">LOGOUT</a>&nbsp;
	<a href="/team_file/Modify/modifyForm.jsp?uid=<%=userId %>">MODIFY</a>&nbsp; 
    <a href="/team_file/Cart/cart.jsp">CART</a>&nbsp; 
    <a href="/team_file/Purchase/purchase.html">ORDER</a> |
    <strong><a href="#">MY PAGE</a></strong>
    <%
    ...
    <a href="#">공지사항</a>&nbsp;
    <a href="#">이벤트</a>&nbsp;
    <a href="/team_file/Inquiry/inquiryboard.html">상품문의</a>&nbsp;
  ...
  <div class="logo"><a href="/team_file/Main/main.jsp"><img src="/team_file/image/MainImage.jpg"></img></a></div>
    <div id="sns">
    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('facebook','','images/facebook_01-02.jpg',1)"><img src="images/youtube_01.jpg" width="40" height="40" id="facebook"></a>
    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('instagram','','images/instagram_02-05.jpg',1)"><img src="images/youtube_02.jpg" width="42" height="40" id="instagram"></a>
    <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('youtube','','images/youtube_03.jpg',1)"><img src="images/instagram_02-03.jpg" width="39" height="40" id="youtube"></a></div>
  ...
  <div class="menu_header">
	...
	Connection conn = ConnectionProvider.getConnection();
		...
		try{
   		...
   		Order order = new Order(userId, pid, orderTime, amount, address, totalPrice);
    ...
    <div id="order_box">
      ...
      <div id="box1">
        <table width="800" border="0" cellspacing="10" cellpadding="1">
          <tr>
            <td><div align="center">다를를 이용해 주셔서 감사합니다.</div></td>
          </tr>
          <tr>
            <td><div align="center">고객님, <span class="point"><%=order.getOdate() %>에 주문이 완료</span>되었습니다.</div></td>
          </tr>
          <tr>
            <td><div align="center">주문내역 확인은 마이페이지에서 하실 수 있습니다</div></td>
          </tr>
          <tr>
          <td>주문 주소 : <%=order.getAddress() %></td>
          </tr>
        </table>
      </div>
      <div id="buttonbox">
        <input type="button" name="orderbutton" id="orderbutton" value="주문내역조회" onclick="location.href='/team_file/MyPage/myPage.jsp'" />
  ...
  <div class="company">
    ...
    <div class="sns"> 
     <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('facebook2','','images/facebook_01-02.jpg',1)"><img src="images/youtube_01.jpg" width="40" height="40" id="facebook2"></a>
     <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('instagram2','','images/instagram_02-05.jpg',1)"><img src="images/youtube_02.jpg" width="42" height="40" id="instagram2"></a>
     <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('youtube2','','images/youtube_03.jpg',1)"><img src="images/instagram_02-03.jpg" width="39" height="40" id="youtube2"></a>
      </div>
  </div>
  <div class="info">
  ...
  <div class="info2">
    ...
    <a href="https://www.inicis.com/"><img src="images/아랫부분_08_01.jpg" width="390" height="138"></a>
    <a href="#"><img src="images/아랫부분_08_02.jpg" width="142" height="96"></a>
    <a href="https://www.ftc.go.kr/"><img src="images/아랫부분_08_03.jpg" width="130" height="96"></a><a href="#"><img src="images/아랫부분_08_04.jpg" width="113" height="96"></a></div>
  </div>
</div>
</div>
