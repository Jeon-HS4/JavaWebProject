...
<div class="wrap">
  ...
  <div class="menu_header">
    <div id="menu">
		...
		if(userId!=null && userId.equals("kakao")){
		...
		<%
			...
			if (user.getPassword().equals(password1)) {
				...
				if (userId.equals("admin"))
					response.sendRedirect("/team_file/Main/main.jsp"); //관리자 로그인시 페이지
				else
					response.sendRedirect("/team_file/Main/main.jsp"); //회원 로그인시 메인페이지로 이동
		} 	else {
		%>
			<script type="text/javascript">
