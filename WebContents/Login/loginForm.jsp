...
<head>
<meta charset="utf-8">
<title>Darle - 로그인</title>

<link href="login.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/team_file/js/rollover.js"></script>
<script src="https://developers.kakao.com/sdk/js/kakao.js"></script>
<script>
Kakao.init('7037f372d188db728145b8f3105cf65d'); //발급받은 키 중 javascript키를 사용해준다.
...
function kakaoLogin() {
    Kakao.Auth.login({
      success: function (response) {
        ...
        window.location.href='/team_file/Login/login.jsp?userId=kakao'
		...
		<form action="login.jsp" method="post">
			<div class="login">
				<div class="login_image">
					<img src="/team_file/image/login.png" width="178" height="87">
				</div>
				<div class="member">
					<a href="#"><img src="/team_file/image/member.png" width="325"
						height="84"></a>
				</div>
				<div class="non_member">
					<a href="#"><img src="/team_file/image/non_member.png" width="325"
						height="84"></a>
				</div>
				...
				<div class="login_submit">
					<input type="submit" name="join" value="로그인">
				</div>
				<div class="kakao">
					<a href="javascript:void(0)" onclick="kakaoLogin()"><img src="/team_file/image/kakao.png" width="650" height="70"></a>
				</div>
				<div class="id_find">
				...
				<div class="sign_up">
					<input type="button" value="회원가입"
						onclick="location.href='/team_file/SignUp/signUpForm.jsp'">
				</div>
			</div>
		</form>
		</div>
