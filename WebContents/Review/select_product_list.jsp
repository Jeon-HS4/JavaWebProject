...
<c:forEach var="p" items="<%=prodlist %>">
	<span style="width: 140px; float: left; text-align: center; margin-top:25px; vertical-align: middle;"><img src="/team_file/image/${p.category}/${p.pimage}/${p.pimage}_1.jpg" width="120px" height="120px"></span>
