  ...
  <div class="menu_header">
    <div id="menu">
		...
		<script type="text/javascript">
			...
			location.href="/team_file/Login/loginForm.jsp"
		</script>
		<%}
		...
		try {
			...
			user = dao1.selectById(conn, login);
			prices = dao2.selectPrice(conn, login);
		...
		<div class="myPage">
			...
			<div class="my_top">
				<img src="mypage.png" width="168" height="78">
			</div>
			<div class="my_modify">
				<a href="/team_file/Modify/modifyForm.jsp?uid=${u.userId}"><img src="modify.png"
					width="158" height="50"></a>
			</div>
			<div class="my_info">
				<div class="my_profile">
					<img src="profile.png" width="220" height="188">
				</div>
				<div class="my_main">
					<div class="welcome">환영합니다. ${u.name} 고객님!</div>
					<div class="my_menu">
						<div class="menu1"><a href="/team_file/Purchase/orderlist.jsp">주문내역</a></div>
						<div class="menu2">
						<a href="/team_file/Cart/cart.jsp">장바구니</a>
						</div>
						<div class="menu3"><a href="#">내 게시글</a></div>
					</div>
					<div class="my_detail">
						<div class="detail1">총 주문액 KRW <%=sum%>원</div> <!--purchase 모델? order 모델? userid와 buyerId 같을 때 sum에 가격 계속 추가방식-->
						<div class="detail2">총 포인트 ${u.point}원</div>
						<div class="detail3">쿠폰 0개</div>
					</div>
				</div>
				<div class="my_name">${u.name}</div>
