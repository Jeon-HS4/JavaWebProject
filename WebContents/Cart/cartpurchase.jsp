...
function payBuyNow(){
	...
	function post_to_url(){
		...
		var path = "/team_file/Cart/cartordercomplete.jsp";
		method = "post";
	...
	<%
			...
			try{
				...
				if(cart != null){
					...
					Purchase purchase = new Purchase(userId, product.getPid(), totalPrice, product.getPrice(), buyTime);
