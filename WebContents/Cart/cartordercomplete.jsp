		...
		try {
			...
			for (int i = 1; i <= pCount.intValue(); i++) {
				...
				if (cart != null) {
					...
					Order order = new Order(userId, pid, new java.util.Date(), amount, address, totalPrice);
  ...
  <div class="main">
    ...
    <div id="order_box">
      ...
      <div id="buttonbox">
        ...
        <input type="button" name="gomain" id="gomain" value="메인으로" onclick="location.href='/team_file/Main/main.jsp'" />
      </div>
 			<%
				}
					}
