...
<div class="wrap">
  ...
  <dl>
    <dt><img src="noimage.jpg" width="112" height="115"></dt>
    <dd><a href="#" onclick="window.open(this.href, '_blank', 'width=450, height=430'); return false;">🔍상품정보선택</a></dd>
  </dl>
  </div>
  <div class = "title">
  <dl>
  	<dt>제목</dt>
    <dd><select style="width:110px;height:35px;font-size:15px;">
      <option>상품문의</option>
      <option>배송문의</option>
      <option>기타문의</option>
    </select>
    <select style="width:490px;height:35px;font-size:15px;">
      <option>[다를]에 문의합니다.</option>
    </select>
    </dd>
  </dl>
  </div>
  ...
  <dl>
    <dt>첨부파일1</dt>
    <dd><input type="file" style="width:500px;height:35px;font-size:16px;"></dd>
  </dl>
  <dl>
  	<dt>비밀번호</dt>
    <dd><input type="password" value = "&{}"placeholder="비밀번호 입력" id ="E8color" 
    style="width:200px;height:35px;font-size:16px;"></dd>
  </dl>
  <dl>
  	<dt>비밀글설정</dt>
    <dd><label><input type="radio" name="choose" value = "공개글" id = "E8color" 
    style="width:20px;height:20px;"> 
      공개글
 	<input type="radio" name="choose" id = "E8color"
    style="width:20px;height:20px;" value = "비밀글" checked> 
        비밀글</label></dd>
  </dl>
  </div>
  </div>
    <div class = "bt_wrap">
    	<a href="nocticeboard.html" class="write">등록</a>
        <a href="noticeboard.html" class="on">취소</a>
    </div>
</div>
  <div class="empty"></div>
