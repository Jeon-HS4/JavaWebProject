...
<div class="wrap">
  ...
  <table width="1580">
  	<tr>
    	<div class="tabletop">
    	<td width ="190">상품 상품}</td>
    	<td width = "1390">제목 제목}</td>
        </div>
  	</tr>
  	<tr>
    	<td width ="190">작성자 작성자명}</td>
    	<td width = "1390">작성일 작성일}</td>
  	</tr>
  	<tr>
    	<td width ="190">조회수 조회수}</td>
    	<td width = "1390">첨부파일 첨부파일}</td>
  	</tr>
  	<tr>
    ...
    <div class = "bt_wrap">
    	<a href="inquiryboard.jsp" class="on">목록</a>
        <a href="inquirywrite.jsp" class="black">수정</a>
    </div>
</div>
   <div class="empty"></div>
