...
<div class="wrap">
  ...
  <div class="menu_header">
	...
	try{
		...
		order = orderDao.selectById(conn, oid);
...
<div class="updateFrm" style="text-align: center; margin-left:800px; margin-top: 100px; margin-bottom: 100px;">
        <c:set var="p" value="<%=order %>"/>
                  <form action="/team_file/Admin/orderUpdate.jsp" method="post" enctype="multipart/form-data" name="form1">
                    <input type="hidden" name="oid" value="${p.oid}" readonly="readonly">
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      <tr>
                        <th><label for="mid">구매 고객</label></th>
                        <td>
                        <input name="mid" type="text" value="${p.mid }" size="70"></td>
                      </tr>
                      <tr>
                        <th><label for="pid">주문 상품</label></th>
                        <td>
                        <input name="pid" type="text" value="${p.pid }" size="70"></td>
                      </tr>
                      <tr>
                        <th><label for="amount">주문 수량</label></th>
                        <td>
                        <input name="amount" type="text" value="${p.amount }"></td>
                      </tr>
                      <tr>
                        <th><label for="address">배송지</label></th>
                        <td>
                        <input name="address" type="text" value="${p.address }"></td>
                      </tr>
                      <tr>
                        <th><label for="totalprice">결제 금액</label></th>
                        <td>
                        <input name="totalprice" type="text" value="${p.totalprice }"></td>
                      </tr>
                      <tr>
