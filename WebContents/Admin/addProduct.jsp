...
<div class="wrap">
  ...
  <form id="addform" action="/team_file/Admin/addProd.jsp" method="post">
  
  <div class = "info">
	<dl>  <dt>상품명</dt>
    <dd><input type="text" name="pname"placeholder="상품명 입력"
    ...
    <dl>  <dt>상품명(영문)</dt>
    <dd><input type="text" name="pimage"
    style="width:300px;height:35px;font-size:16px;"></dd>
    </dl>
    <dl>  <dt>카테고리</dt>
    <dd><select style="width:110px;height:35px;font-size:15px;" name="category">
      <option>outer</option>
      <option>top</option>
    ...
    <dl>  <dt>상품 색상</dt>
    <dd><select style="width:110px;height:35px;font-size:15px;" name="pcolor">
      <option>2Color</option>
      <option>3Color</option>
      <option>4Color</option>
      <option>5Color</option>
    </select> </dd> </dl>
  </div>
    </form>
 </div>
    ...
    <div class = "bt_wrap">
    	<input type="submit" form="addform" class="write" value="상품추가">
        <input type="button" class="on" onclick="cancel1()" value="취소하기">
    </div>
</div>
<script type="text/javascript">

   	function cancel1(){
   		var cancel = confirm("상품 추가를 취소하시겠습니까?");
   		if(cancel){
   			location.href="/team_file/Admin/prodlist.jsp";
   		}else{
   			history.go(-1);
   		}
   	}
