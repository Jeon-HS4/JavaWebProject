...
<div class="wrap">
  ...
  <div class="menu_header">
	...
	try{
		...
		user = UserDao.selectById(conn, uid);
...
<div class="updateFrm" style="text-align: center; margin-left:800px; margin-top: 100px; margin-bottom: 100px;">
        <c:set var="p" value="<%=user %>"/>
                  <form action="/team_file/Admin/userUpdate.jsp" method="post" enctype="multipart/form-data" name="form1">
                    <input type="hidden" name="pid" value="${p.userId}">
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      <tr>
                        <th><label for="idfield">아 이 디</label></th>
                        <td>
                        <input name="idfield" type="text" value="${p.userId }" size="70" readonly="readonly"></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th><label for="phonefield">연 락 처</label></th>
                        <td>
                        <input name="phonefield" type="text" value="${p.phone1}-${p.phone2}-${p.phone3}"></td>
                      </tr>
                      <tr>
                        <th><label for="emailfield">이 메 일</label></th>
                        <td>
                        <input name="emailfield" type="text" value="${p.email }"></td>
                      </tr>
                      <tr>
                        <th><label for="addressfield">주 소</label></th>
                        <td>
                        <input name="addressfield" type="text" value="${p.address }"></td>
                      </tr>
					  <tr>
                        <th><label for="pointfield">적 립 금</label></th>
                        <td>
                        <input name="pointfield" type="text" value="${p.point }"></td>
                      </tr>
                      <tr>
                        <td height="30" colspan="2" align="center" class="btnstyle"><input type="submit" name="ok" id="ok" value="확인">
                        <input type="button" name="cancel" id="cancel" value="취소" onclick="cancel1()"></td>
                      </tr>
                    </table>
    <script type="text/javascript">
    	function cancel1(){
    		...
    		if(cancel){
    			location.href="/team_file/Admin/userlist.jsp";
    		}else{
    			history.go(-1);
    		}
    	}
